...
if (isset($_POST['btn_addmovie'])) {
    ...
    echo "File upload failed: " . $_FILES["fileToUpload"]["error"];
        ...
        $insert_stmt->bind_param('ssississ', $movieName, $movieDescription, $movieDuration, $releaseDate, $imgpath, $languageId,$trailer,$movievideo);
...
$movieId = $_POST['movie_id'];
  ...
  if ($check_stmt->num_rows > 0) {
        ...
        $stmt->bind_param('sssisissi', $newMovieName, $imgpath, $newMovieDescription, $newMovieDuration, $newReleaseDate, $newLanguageId,$trailer, $movievideo, $movieId);
...
foreach ($rows as $row) {
    echo "<tr>";
    echo "<td>{$row['id']}</td>";
    echo "<td><img src='../{$row['movie_banner']}' width='250rem'></td>";
    echo "<td>{$row['name']}</td>";
    ...
    <div class="row">
        ...
        <?php } ?>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="movieName">Video URL</label>
                        <input type="text" class="form-control" id="movieName" name="movievideo" required>
                    </div>
                    <!-- Add Movie Video Input Here -->
<!--<div class="form-group">
    <label for="movieVideo">Movie Video</label><br>
    <input type="file" name="movieVideo" id="movieVideo" accept="video/*" required>
</div>-->
